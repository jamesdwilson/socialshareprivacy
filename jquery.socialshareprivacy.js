...
(function ($) {
    ...
    $.fn.socialSharePrivacy = function (settings) {
        var defaults = {
            ...
            'info_link'         : '#',
            'txt_help'          : 'When you activate these fields by clicking, information to Facebook, Twitter and Google will be transferred to them and according to their individual policies may also be stored there indefinitely. This does not happen until you click to activate each one.',
            'settings_perma'    : 'Permanently enable actiation and data transmission',
            'cookie_path'       : '/',
